...
class MethodRequest:
    ...
    @classmethod
    def get_customer_pm_report(cls, start_date: str | None, end_date: str | None, customer_name: str, wo_filter: str | None, skip_amount=0) -> str:
        if start_date:
    ...
    def increment_skip(request_string: str) -> str:
        skip_param = re.compile('skip\d*')
        if 'skip=' in request_string:
            pass
